...
// Discover movies with provider, keyword, exclude genres, language, and vote count filter
  ...
  // Quality-gems discover: same filters as discoverMovies/discoverTv but rating-sorted with a
  // vote floor (max(minVotes, 300)) and a recency window, so well-rated low-buzz titles that
